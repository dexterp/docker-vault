...
MAINTAINER Dexter Plameras <dpgrps@gmail.com>
...
RUN adduser --system --user-group --home-dir /vault --create-home vault

# Set up certificates, our base tools, and Vault.
RUN yum install -y ca-certificates gnupg2 openssl libcap jq wget which unzip
RUN gpg -K && gpg --recv-keys 91A6E7F85D05C65630BEF18951852D87348FFC4C
